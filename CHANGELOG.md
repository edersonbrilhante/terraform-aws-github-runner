...
* **scale-set:** add service controller ([#5300](https://github.com/edersonbrilhante/terraform-aws-github-runner/issues/5300)) ([852b92e](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/852b92e1b75e4b85ec63fe45a36a2ae948826fa1))
* **scale-set:** isolate orchestration provider module ([150638c](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/150638c4143447cb9315af39bf6d5cbeedbc9d8a))
* **scale-set:** wire orchestration through runner config ([#5350](https://github.com/edersonbrilhante/terraform-aws-github-runner/issues/5350)) ([527dadd](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/527dadde912a3649b1a937ca754878d12f9653e8))
...
* fix conflicts ([ddda517](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/ddda5177a67eb5efd94182eafb1c0e498b63b880))
* fix conflicts ([fa85df7](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/fa85df737fbe2e96dd7d330f2003732290fc9e82))
* fix tests ([ec123d2](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/ec123d2df861106c616f0a3c6d057a8fb8a6c989))
...
* fix validations ([99ae1bc](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/99ae1bc6ed525f08be25698f79a26c5db239ba69))
...
* **multi-runner:** validate scale-set installation inputs ([4d8cffa](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/4d8cffad6d8317b44094251f0b3fb5da0035cbcb))
...
* **scale-set:** remove invalid policy validation reference ([c91d8ca](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/c91d8cafb2e6713ccd10e23f5b160047fa598800))
* **scale-set:** use declared task policy for quota validation ([0379201](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/037920104fd16a9c031c0b27f3fab58bff0bcdd9))
* **scale-set:** validate compute task policy ([c87e2b8](https://github.com/edersonbrilhante/terraform-aws-github-runner/commit/c87e2b8dcf424c86f700953c06682358bbd14f9d))
